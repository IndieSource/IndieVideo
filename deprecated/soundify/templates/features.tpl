...
<div class="content">
	...
	<div class="section">
		<div class="row">
			...
			<div class="col-sm-6">
				<a class="unstyled" href="#features/themeable">
					<div class="attention"><div class="emphasis">Define Your Own Look and Feel</div></div>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="section">
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="attention"><div class="emphasis">Apps and Sharing Work Together</div></div>
			</div>
		</div>
	</div>
