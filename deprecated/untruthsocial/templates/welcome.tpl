<div class="primary colored section">
	<div class="row">
		<div class="col-sm-6">
			<h2><img class="icon" src="images/logos/icon-light.svg" />What is <%= application.name %>?</h2>
...
<div class="section">
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="figure">
				<a href="#downloads">
					<img style="width:150px; margin-bottom:-20px" src="images/logos/kitty-icon.svg" />
				</a>
...
<div class="section">
	<div class="row">
		<div class="col-sm-6">
			<h2><i class="fa fa-smile"></i>Keep in Touch with Friends</h2>
			<p>Set up your own personalized <%= application.name %> to keep up to date with your group of friends. Customize the colors and branding to make your own friendly, personal online hangout spot. </p>
		</div>
		<div class="col-sm-6">
			<div class="figure">
...
<div class="section">
	<div class="row">
		<div class="col-sm-6">
			<h2><i class="fa fa-blackboard"></i>Connect the Classroom</h2>
			<p>If you are an educator, you can use <%= application.name %> to create a private and welcoming environment for your students. Since the environment is your own private micro-platform, it can be a safe and secure place. </p>
		</div>
		<div class="col-sm-6">
			<div class="figure">
...
<div class="section">
	<div class="row">
		<div class="col-sm-6">
			<h2><i class="fa fa-users"></i>Meet New People</h2>
			<p>Host your own <%= application.name %> to create an online forum for whatever you're interested in.  Meet new people, make new friends. </p>
		</div>
		<div class="col-sm-6">
			<div class="figure">
...
<div class="section">
	<div class="row">
		<div class="col-sm-6">
			...
			<p>You no longer need to give up control over your data just to get access to a technology platform. By running your own <%= application.name %>, you control the platform and your conversations. Join the <a href="#features/host-it-yourself">host it yourself (HIY)</a> movement and take back control over your (digital) life! </p>
		</div>
		<div class="col-sm-6">
			<div class="figure">
