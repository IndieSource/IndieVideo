<h1><i class="fa fa-key"></i>Changing Your Password</h1>

<ol class="breadcrumb">
	<li><a href="#help"><i class="fa fa-question-circle"></i>Help</a></li>
	<li><a href="#help/managing-account"><i class="fa fa-user"></i>Managing Your Account</a></li>
	<li><i class="fa fa-key"></i>Changing Your Password</li>
</ol>

<div class="content">
	<p>If you would like to change your password, either for personal preferences or for security reasons, you may do so at any time by following these steps.</p>
	...
	<ol>
		...
		<li>
			<h2><i class="fa fa-key"></i>Click on Change Password Button</h2>
		...
		<li>
			<h2><i class="fa fa-pencil-alt"></i>Enter and Confirm Password</h2>
