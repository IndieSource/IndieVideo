<h1><i class="fa fa-share"></i>File Sharing</h1>

<ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-home"></i>Home</a></li>
	<li><a href="#uses"><i class="fa fa-user-circle"></i>Uses</a></li>
	<li><i class="fa fa-share"></i>File Sharing</li>
</ol>

<div class="content">
	<div class="attention"><i class="fa fa-share"></i></div>
	...
	<div class="details section">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<ul>
					<li>Share your digital world with friends and colleages. </li>
					<li>Control exactly how, with who, and for how long your data is shared. </li>
				</ul>
			</div>
		</div>
	</div>
