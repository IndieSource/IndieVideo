...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/contact-editor/contact-editor.png" target="_blank" class="lightbox" data-caption="<%= config.apps.contact_editor.name %>"><img class="dialog" src="images/info/apps/contact-editor/contact-editor.png" /></a>
		<div class="caption"><%= config.apps.contact_editor.name %></div>
	</div>
	<div class="figure mobile-only">
		<a href="images/info/apps/contact-editor/mobile/mobile-contact-editor.png" target="_blank" class="lightbox" data-caption="<%= config.apps.contact_editor.name %>"><img src="images/info/apps/contact-editor/mobile/mobile-contact-editor.png" /></a>
		<div class="caption"><%= config.apps.contact_editor.name %></div>
	</div>
</div>