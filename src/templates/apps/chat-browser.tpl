...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/chat-browser/chat-browser.png" target="_blank" class="lightbox" data-caption="<%= config.apps.chat_browser.name %>"><img class="dialog" src="images/info/apps/chat-browser/chat-browser.png" /></a>
