...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/topic-browser/topic-browser.png" target="_blank" class="lightbox" data-caption="<%= config.apps.topic_browser.name %>"><img class="dialog" src="images/info/apps/topic-browser/topic-browser.png" /></a>
		<div class="caption"><%= config.apps.topic_browser.name %></div>
	</div>
	<div class="figure mobile-only">
		<a href="images/info/apps/topic-browser/mobile/mobile-topic-browser.png" target="_blank" class="lightbox" data-caption="<%= config.apps.topic_browser.name %>"><img src="images/info/apps/topic-browser/mobile/mobile-topic-browser.png" /></a>
		<div class="caption"><%= config.apps.topic_browser.name %></div>
	</div>
</div>