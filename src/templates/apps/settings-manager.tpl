...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/settings-manager/settings-manager.png" target="_blank" class="lightbox" data-caption="<%= config.apps.settings_manager.name %>"><img class="dialog" src="images/info/apps/settings-manager/settings-manager.png" /></a>
		<div class="caption"><%= config.apps.settings_manager.name %></div>
	</div>
	<div class="figure mobile-only">
		<a href="images/info/apps/settings-manager/mobile/mobile-settings-manager.png" target="_blank" class="lightbox" data-caption="<%= config.apps.settings_manager.name %>"><img class="dialog" src="images/info/apps/settings-manager/mobile/mobile-settings-manager.png" /></a>
		<div class="caption"><%= config.apps.settings_manager.name %></div>
	</div>
</div>