...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/connection-manager/connection-manager.png" target="_blank" class="lightbox" data-caption="<%= config.apps.connection_manager.name %>"><img class="dialog" src="images/info/apps/connection-manager/connection-manager.png" /></a>
