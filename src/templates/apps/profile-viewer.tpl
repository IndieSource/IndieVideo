...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/profile-viewer/profile-viewer.png" target="_blank" class="lightbox" data-caption="<%= config.apps.profile_viewer.name %>"><img class="dialog" src="images/info/apps/profile-viewer/profile-viewer.png" /></a>
