...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/help-viewer/help-viewer.png" target="_blank" class="lightbox" data-caption="<%= config.apps.help_viewer.name %>"><img class="dialog" src="images/info/apps/help-viewer/help-viewer.png" /></a>
		<div class="caption"><%= config.apps.help_viewer.name %></div>
	</div>
	<div class="figure mobile-only">
		<a href="images/info/apps/help-viewer/mobile/mobile-help-viewer.png" target="_blank" class="lightbox" data-caption="<%= config.apps.help_viewer.name %>"><img src="images/info/apps/help-viewer/mobile/mobile-help-viewer.png" /></a>
		<div class="caption"><%= config.apps.help_viewer.name %></div>
	</div>
</div>