...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/profile-browser/profile-browser.png" target="_blank" class="lightbox" data-caption="<%= config.apps.profile_browser.name %>"><img class="dialog" src="images/info/apps/profile-browser/profile-browser.png" /></a>
		<div class="caption"><%= config.apps.profile_browser.name %></div>
	</div>
	<div class="figure mobile-only">
		<a href="images/info/apps/profile-browser/mobile/mobile-profile-browser.png" target="_blank" class="lightbox" data-caption="<%= config.apps.profile_browser.name %>"><img class="dialog" src="images/info/apps/profile-browser/mobile/mobile-profile-browser.png" /></a>
		<div class="caption"><%= config.apps.profile_browser.name %></div>
	</div>
</div>