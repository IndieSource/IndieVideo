...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/map-viewer/map-viewer.png" target="_blank" class="lightbox" data-caption="<%= config.apps.map_viewer.name %>"><img class="dialog" src="images/info/apps/map-viewer/map-viewer.png" /></a>
		<div class="caption"><%= config.apps.map_viewer.name %></div>
	</div>
	<div class="figure mobile-only">
		<a href="images/info/apps/map-viewer/mobile/mobile-map-viewer.png" target="_blank" class="lightbox" data-caption="<%= config.apps.map_viewer.name %>"><img src="images/info/apps/map-viewer/mobile/mobile-map-viewer.png" /></a>
		<div class="caption"><%= config.apps.map_viewer.name %></div>
	</div>
</div>