...
<div class="content">
	...
	<div class="figure desktop-only">
		<a href="images/info/apps/pdf-viewer/pdf-viewer.png" target="_blank" class="lightbox" data-caption="<%= config.apps.pdf_viewer.name %>"><img class="dialog" src="images/info/apps/pdf-viewer/pdf-viewer.png" /></a>
		<div class="caption"><%= config.apps.pdf_viewer.name %></div>
	</div>
	<div class="figure mobile-only">
		<a href="images/info/apps/pdf-viewer/mobile/mobile-pdf-viewer.png" target="_blank" class="lightbox" data-caption="<%= config.apps.pdf_viewer.name %>"><img src="images/info/apps/pdf-viewer/mobile/mobile-pdf-viewer.png" /></a>
		<div class="caption"><%= config.apps.pdf_viewer.name %></div>
	</div>
</div>